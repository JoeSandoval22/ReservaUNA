...
public class ManagerGUI implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        LabelNombre.setText("María Solís");
        LabelCorreo.setText("msolis@una.ac.cr");
        LabelReservasActivas.setText("2");
        LabelPendientes.setText("3");
    ...
    @FXML private void btnIngresarAprobar(ActionEvent e) {
        cargarPantalla("/cr/ac/una/reservauna/Views/handleStatus.fxml", btnNuevaReserva);
    }
